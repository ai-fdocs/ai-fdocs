...
- [ ] A4. Описать endpoint-контракт (request/response, retry, лимиты, таймауты, коды ошибок) в `docs/API_CONTRACT.md`.
- [ ] A5. Зафиксировать политику свежести (TTL, revalidation, force refresh).
- [ ] A6. Зафиксировать политику деградации (какие ошибки фатальны, какие non-fatal с best-effort).
